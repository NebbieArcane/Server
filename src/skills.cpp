...
ACTION_FUNC(do_finger) {
	...
	if(percent > ch->skills[SKILL_FINGER].learned) {
        ...
        if(HasClass(ch, CLASS_MONK) && IS_PC(ch))
        {
            if(IS_POLY(ch))
            {
                ch->desc->original->specials.achie_class[ACHIE_MONK_3] += 1;
                if(!IS_SET(ch->desc->original->specials.act,PLR_ACHIE))
                    SET_BIT(ch->desc->original->specials.act, PLR_ACHIE);
            }
            else
            {
                ch->specials.achie_class[ACHIE_MONK_3] += 1;
                if(!IS_SET(ch->specials.act,PLR_ACHIE))
                    SET_BIT(ch->specials.act, PLR_ACHIE);
            }
...
ACTION_FUNC(do_first_aid) {
	...
	if(number(1, 101) < ch->skills[SKILL_FIRST_AID].learned) {
        ...
        if(HasClass(ch, CLASS_BARBARIAN) && IS_PC(ch))
        {
            if(IS_POLY(ch))
            {
                ch->desc->original->specials.achie_class[ACHIE_BARBARIAN_3] += 1;
                if(!IS_SET(ch->desc->original->specials.act,PLR_ACHIE))
                    SET_BIT(ch->desc->original->specials.act, PLR_ACHIE);
            }
            else
            {
                ch->specials.achie_class[ACHIE_BARBARIAN_3] += 1;
                if(!IS_SET(ch->specials.act,PLR_ACHIE))
                    SET_BIT(ch->specials.act, PLR_ACHIE);
            }
...
ACTION_FUNC(do_tan) {
	...
	char itemname[80],itemtype[80],article[80],hidetype[80],hidekeys[80],buf[MAX_STRING_LENGTH];
	int percent=0;
	int i =0 ;
	...
	if(MOUNTED(ch)) {
		send_to_char("Non puoi conciare da cavallo!\n\r",ch);
		return;
	}

	if(IS_PC(ch) || IS_SET(ch->specials.act,ACT_POLYSELF)) {
		if(!HasClass(ch,CLASS_BARBARIAN|CLASS_WARRIOR|CLASS_RANGER|CLASS_DRUID)) {
			send_to_char("Pensi di essere un conciatore?\n\r",ch);
			return;
		}
	}
	...
	if(!*itemname) {
		send_to_char("Scuoiare cosa??\n\r",ch);
		return;
	}

	if(!*itemtype) {
		send_to_char("Si certo, ma cosa vuoi creare di preciso?\n\r",ch);
		return;
	}

	if(!(j = get_obj_in_list_vis(ch, itemname,
								 real_roomp(ch->in_room)->contents))) {
		send_to_char("Dov'e' andata la carcassa\n\r",ch);
		return;
	}
	else {
		...
		if(j->affected[0].modifier !=0 && j->affected[1].modifier !=0) {
			...
			if(ch->skills && ch->skills[ SKILL_TAN ].learned &&
				...
				if(percent > ch->skills[SKILL_TAN].learned) {
					...
					sprintf(buf,
							"Tenti di scuoiare %s ma non fai altro che distruggerne la pelle.\n\r",
							j->short_description);
					send_to_char(buf,ch);

					sprintf(buf, "%s tenta di scuoiare %s ma non fa altro che distruggerne la pelle.",
				...
				if(!j->obj_flags.value[ 3 ]) {
					send_to_char("Non e' esattamente un corpo.\n\r",ch);
					return;
				}
				...
				case RACE_HALFBREED :
					...
					break;
				case RACE_HUMAN     :
					sprintf(hidetype," di pelle umana");
                    sprintf(hidekeys," pelle umana");
					acapply=-1;
					lev=(int)lev/2;
					break;
				case RACE_ELVEN     :
					sprintf(hidetype," di pelle elfica");
                    sprintf(hidekeys," pelle elfica elfo");
					acapply=-1;
					lev=(int)lev/2;
					break;
				case RACE_DWARF     :
					sprintf(hidetype," di pelle nanica");
                    sprintf(hidekeys," pelle nanica nano");
					acapply=-1;
					lev=(int)lev/2;
					break;
				case RACE_HALFLING  :
					...
					break;
				case RACE_GNOME     :
					sprintf(hidetype," di pelle gnomica");
                    sprintf(hidekeys," pelle halfbreed");
					acapply=-1;
					lev=(int)lev/2;
					break;
				...
				case RACE_SPECIAL  :
				case RACE_LYCANTH  :
					sprintf(hidetype," di pelliccia");
                    sprintf(hidekeys," pelliccia");
					acapply=2;
					break;
				case RACE_DRAGON   :
				...
				case RACE_UNDEAD_GHOUL    :
					sprintf(hidetype," d'ossa");
                    sprintf(hidekeys," ossa");
					acapply=-2;
					lev=(int)lev/2;
					break;
				case RACE_ORC      :
					sprintf(hidetype," di pelle orchesca");
                    sprintf(hidekeys," pelle orchesca orco");
					acapply=0;
					lev=(int)lev/2;
					break;
				case RACE_INSECT   :
					sprintf(hidetype," di carapace d'insetto");
                    sprintf(hidekeys," carapace insetto");
					acapply=2;
					break;
				case RACE_ARACHNID :
					sprintf(hidetype," di ragnatele");
                    sprintf(hidekeys," ragnatele ragno");
					acapply=1;
					lev=(int)lev/2;
					break;
				case RACE_DINOSAUR :
					...
					break;
				case RACE_FISH     :
					sprintf(hidetype," di lische");
                    sprintf(hidekeys," lische pesce");
					acapply=3;
					break;
				case RACE_BIRD     :
					sprintf(hidetype," di piume");
                    sprintf(hidekeys," piume uccello");
					acapply=0;
					lev=(int)lev/2;
					break;
				case RACE_GIANT    :
					...
					break;
				case RACE_PREDATOR :
					sprintf(hidetype," di pelle elastica");
                    sprintf(hidekeys," pelle elastica");
					acapply=1;
					break;
				case RACE_PARASITE :
					sprintf(hidetype," di pelle purulenta");
                    sprintf(hidekeys," pelle purulenta");
					acapply=1;
					break;
				case RACE_SLIME    :
					sprintf(hidetype," di materia gelatinosa");
                    sprintf(hidekeys," materia gelatinosa slime");
					acapply=0;
					lev=(int)lev/2;
					break;
				case RACE_DEMON    :
				...
				case RACE_SNAKE    :
					...
					break;
				case RACE_HERBIV   :
					sprintf(hidetype," di pelle gialla");
                    sprintf(hidekeys," pelle gialla");
					acapply=1;
					break;
				case RACE_TREE     :
					sprintf(hidetype," di corteccia");
                    sprintf(hidekeys," corteccia albero");
					acapply=5;
					break;
				case RACE_VEGGIE   :
					sprintf(hidetype," di foglie");
                    sprintf(hidekeys," foglie pianta");
					acapply=2;
					break;
				case RACE_ELEMENT  :
					sprintf(hidetype," di pelle colorata");
                    sprintf(hidekeys," pelle colorata elementale");
					acapply=1;
					break;
				case RACE_PLANAR   :
					...
					break;
				case RACE_DEVIL    :
					sprintf(hidetype," di pelle rosso sangue");
                    sprintf(hidekeys," pelle diavolo");
					acapply=4;
					break;
				case RACE_GHOST    :
					sprintf(hidetype," di tessuti trasparenti");
                    sprintf(hidekeys," tessuti trasparenti fantasma");
					acapply=1;
					break;
				case RACE_GOBLIN   :
				...
				case RACE_GNOLL    :
					...
					break;
				case RACE_VEGMAN   :
					sprintf(hidetype," di fibre vegetali");
                    sprintf(hidekeys," pelle fibre vegetale");
					acapply=2;
					break;
				case RACE_MFLAYER  :
				...
				case RACE_LABRAT   :
				case RACE_SARTAN   :
					sprintf(hidetype," di pelle sporca");
                    sprintf(hidekeys," pelle sporca");
					acapply=1;
					break;
				case RACE_TYTAN   :
				...
				case RACE_HORSE    :
				case RACE_DRAAGDIM :
					sprintf(hidetype," di pellame");
                    sprintf(hidekeys," pellame");
					acapply=2;
					break;
				case RACE_ASTRAL   :
					sprintf(hidetype," di pelle sconosciuta");
                    sprintf(hidekeys," pelle sconosciuta");
					acapply=2;
					break;
				case RACE_GOD      :
					sprintf(hidetype," di materia divina");
                    sprintf(hidekeys," materia divina");
					acapply=3;
					break;
				case RACE_GIANT_HILL   :
					sprintf(hidetype," verde collina");
                    sprintf(hidekeys," pelle gigante colline");
					acapply=2;
					break;
				case RACE_GIANT_FROST  :
					sprintf(hidetype," azzurro ghiaccio");
                    sprintf(hidekeys," pelle gigante ghiacci");
					acapply=2;
					break;
				case RACE_GIANT_FIRE   :
					sprintf(hidetype," rosso fuoco");
                    sprintf(hidekeys," pelle gigante fuoco");
					acapply=2;
					break;
				case RACE_GIANT_CLOUD  :
					sprintf(hidetype," bianco nuvola");
                    sprintf(hidekeys," pelle gigante nuvole");
					acapply=1;
					break;
				case RACE_GIANT_STORM  :
					sprintf(hidetype," blu tempesta");
                    sprintf(hidekeys," pelle gigante tempeste");
					acapply=2;
					break;
				case RACE_GIANT_STONE  :
					sprintf(hidetype," grigio pietra");
                    sprintf(hidekeys," pezzi gigante pietra");
					acapply=3;
					break;
				...
				else if(!strcmp(itemtype,"armatura")) {
				...
				else if(!strcmp(itemtype,"giacca")) {
				...
				else if(!strcmp(itemtype,"stivali")) {
				...
				else if(!strcmp(itemtype,"guanti")) {
				...
				else if(!strcmp(itemtype,"gambali")) {
				...
				else if(!strcmp(itemtype,"maniche")) {
				...
				sprintf(buf,"Scuoi %s e ne ricavi %s%s.\n\r",
						j->short_description,article,itemtype);
				send_to_char(buf,ch);

				sprintf(buf,"%s scuoia %s e ne ricava un pezzo d'equipaggiamento.",GET_NAME(ch),
						j->short_description);
				act(buf,TRUE, ch, 0, 0, TO_ROOM);
                ...
                if(HasClass(ch, CLASS_RANGER) && IS_PC(ch))
                {
                    if(IS_POLY(ch))
                    {
                        ch->desc->original->specials.achie_class[ACHIE_RANGER_1] += 1;
                        if(!IS_SET(ch->desc->original->specials.act,PLR_ACHIE))
                            SET_BIT(ch->desc->original->specials.act, PLR_ACHIE);
                    }
                    else
                    {
                        ch->specials.achie_class[ACHIE_RANGER_1] += 1;
                        if(!IS_SET(ch->specials.act,PLR_ACHIE))
                            SET_BIT(ch->specials.act, PLR_ACHIE);
                    }
			...
			send_to_char("Non ci sono abbastanza resti per creare qualcosa.\n\r",ch);
			return;
		}
	}
}
...
ACTION_FUNC(do_carve) {
	...
	if((r_num = real_object(FOUND_FOOD)) >= 0) {
        ...
        if(HasClass(ch, CLASS_RANGER) && IS_PC(ch))
        {
            if(IS_POLY(ch))
            {
                ch->desc->original->specials.achie_class[ACHIE_RANGER_3] += 1;
                if(!IS_SET(ch->desc->original->specials.act,PLR_ACHIE))
                    SET_BIT(ch->desc->original->specials.act, PLR_ACHIE);
            }
            else
            {
                ch->specials.achie_class[ACHIE_RANGER_3] += 1;
                if(!IS_SET(ch->specials.act,PLR_ACHIE))
                    SET_BIT(ch->specials.act, PLR_ACHIE);
            }
...
ACTION_FUNC(do_doorway) {
	...
	if((GET_MANA(ch) < 20) && GetMaxLevel(ch) <= PRINCIPE) {  // SALVO mana negativa solo agli immortali
        ...
        if(HasClass(ch, CLASS_PSI) && IS_PC(ch))
        {
            if(IS_POLY(ch))
            {
                ch->desc->original->specials.achie_class[ACHIE_PSI_1] += 1;
                if(!IS_SET(ch->desc->original->specials.act,PLR_ACHIE))
                    SET_BIT(ch->desc->original->specials.act, PLR_ACHIE);
            }
            else
            {
                ch->specials.achie_class[ACHIE_PSI_1] += 1;
                if(!IS_SET(ch->specials.act,PLR_ACHIE))
                    SET_BIT(ch->specials.act, PLR_ACHIE);
            }
...
ACTION_FUNC(do_blast) {
    ...
    if(HasClass(ch, CLASS_PSI) && IS_PC(ch))
    {
        if(IS_POLY(ch))
        {
            ch->desc->original->specials.achie_class[ACHIE_PSI_2] += 1;
            if(!IS_SET(ch->desc->original->specials.act,PLR_ACHIE))
                SET_BIT(ch->desc->original->specials.act, PLR_ACHIE);
        }
        else
        {
            ch->specials.achie_class[ACHIE_PSI_2] += 1;
            if(!IS_SET(ch->specials.act,PLR_ACHIE))
                SET_BIT(ch->specials.act, PLR_ACHIE);
        }
...
ACTION_FUNC(do_adrenalize) {
	...
	if(GET_MANA(ch) < 15 && GetMaxLevel(ch) < IMMORTALE) {
		send_to_char("Non hai abbastanza energia metale per farlo.\n\r",ch);
		return;
	}
    ...
    if(HasClass(ch, CLASS_PSI) && ch != target && IS_PC(target) && IS_PC(ch))
    {
        if(IS_POLY(ch))
        {
            ch->desc->original->specials.achie_class[ACHIE_PSI_3] += 1;
            if(!IS_SET(ch->desc->original->specials.act,PLR_ACHIE))
                SET_BIT(ch->desc->original->specials.act, PLR_ACHIE);
        }
        else
        {
            ch->specials.achie_class[ACHIE_PSI_3] += 1;
            if(!IS_SET(ch->specials.act,PLR_ACHIE))
                SET_BIT(ch->specials.act, PLR_ACHIE);
        }
...
ACTION_FUNC(do_blessing) {
    ...
    if(HasClass(ch, CLASS_PALADIN) && IS_PC(ch))
    {
        if(IS_POLY(ch))
        {
            ch->desc->original->specials.achie_class[ACHIE_PALADIN_1] += 1;
            if(!IS_SET(ch->desc->original->specials.act,PLR_ACHIE))
                SET_BIT(ch->desc->original->specials.act, PLR_ACHIE);
        }
        else
        {
            ch->specials.achie_class[ACHIE_PALADIN_1] += 1;
            if(!IS_SET(ch->specials.act,PLR_ACHIE))
                SET_BIT(ch->specials.act, PLR_ACHIE);
        }
...
ACTION_FUNC(do_lay_on_hands) {
    ...
    if(HasClass(ch, CLASS_PALADIN) && IS_PC(ch))
    {
        if(IS_POLY(ch))
        {
            ch->desc->original->specials.achie_class[ACHIE_PALADIN_3] += 1;
            if(!IS_SET(ch->desc->original->specials.act,PLR_ACHIE))
                SET_BIT(ch->desc->original->specials.act, PLR_ACHIE);
        }
        else
        {
            ch->specials.achie_class[ACHIE_PALADIN_3] += 1;
            if(!IS_SET(ch->specials.act,PLR_ACHIE))
                SET_BIT(ch->specials.act, PLR_ACHIE);
        }
...
ACTION_FUNC(do_holy_warcry) {
	...
	if(ch->skills[SKILL_HOLY_WARCRY].learned<number(1,101))  {
        ...
        if(HasClass(ch, CLASS_PALADIN) && IS_PC(ch))
        {
            if(IS_POLY(ch))
            {
                ch->desc->original->specials.achie_class[ACHIE_PALADIN_2] += 1;
                if(!IS_SET(ch->desc->original->specials.act,PLR_ACHIE))
                    SET_BIT(ch->desc->original->specials.act, PLR_ACHIE);
            }
            else
            {
                ch->specials.achie_class[ACHIE_PALADIN_2] += 1;
                if(!IS_SET(ch->specials.act,PLR_ACHIE))
                    SET_BIT(ch->specials.act, PLR_ACHIE);
            }
