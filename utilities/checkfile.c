...
struct char_player_data
{
  ...
  int user_flags;        /* no delete, ansi etc... */
  ...
  int extra_flags;   /* for ressurection in the future , etc */
...
struct char_special_data
{
  ...
  char *AuthorizedBy;       /*Nome dell'immortale che ha autorizzato
   ...
   int TempoPassatoIn[MAX_POSITION];
  short PosPrev;
  short WimpyLevel;
  ...
  unsigned int affected_by2; /* Other special things */
