...
def get_base_bosses() -> list[Archetype]:
    return [
        ...
        _A(
            ...
            "Artigli lunghi hanno scritto segni sulle pareti.",
            "Il predatore si lancia all'istinto.",
            "Un urlo cavernoso.",
        ),
        _A(
            "RACE_INSECT",
        ...
        _A(
            ...
            "Una creatura alata coronata di ossa volteggia bassa.",
        ...
        _A(
            ...
            "Runa necromantiche bruciano come brace nel vuoto degli occhi.",
        ...
        _A(
            ...
            "Una aracnide titanica attende nel buio filando seta nera.",
        ...
        _A(
            ...
            "Una arpia regale plana su artigli insanguinati.",
        ...
        _A(
            ...
            "Runa di guerra bruciano sulla sua pelle grigio-ferro.",
        ...
        _A(
            ...
            "Legno che scricchiola minaccioso.",
        ),
        _A(
            "RACE_DEMON",
            "demone fessure",
            ...
            "Zolfo e cenere gli aleggiano attorno.",
        ...
        _A(
            ...
            "Canini affilati e occhi cremisi non tradiscono eta'.",
            "Il Signore si scaglia famelico.",
        ...
        _A(
            ...
            "Uno spirito di saggio nano urla profezie nel buio.",
        ...
        _A(
            ...
            "Una creatura che imita trono e tesoro attende immobile.",
...
def _mob_categories() -> list[list[Archetype]]:
    ...
    cats.append(
        [
            ...
            _A("RACE_GOBLIN", "goblin sciamano", "Goblin Sciamano", "Un goblin coperto di rune brandisce un bastone di ossa.", "Occhi gialli brillano di follia shamanica.", "Lo sciamano invoca fulmini verdi.", "Mormorii gutturali."),
            _A("RACE_GOBLIN", "goblin arcere", "Goblin Arciere", "Un goblin armato di arco corto mira dall'ombra.", "Frecce avvelenate spuntano dal carquois.", "L'arcere scocca una freccia.", "Frecce che fischiano."),
    ...
    cats.append(
        [
            ...
            _A("RACE_TROGMAN", "troglodita guerriero", "Troglodita Guerriero", "Un uomo-delle-caverne brandisce clava di osso.", "Pelle pallida e occhi ciechi al sole.", "Il troglodita colpisce alla cieca.", "Grugniti cavernosi."),
            ...
            _A("RACE_GOBLIN", "goblin alchimista", "Goblin Alchimista", "Un goblin maneggia fiale fumanti con cautela.", "Esplosioni recenti hanno bruciato metade del volto.", "L'alchimista lancia acido.", "Vetro che si rompe."),
    ...
    cats.append(
        [
            ...
            _A("RACE_UNDEAD_ZOMBIE", "zombie contadino", "Zombie Contadino", "Un cadavere rigido avanza con braccia tese.", "Vestiti lacera e occhi vitrei.", "Lo zombie cerca di afferrarti.", "Gemiti soffocati."),
            ...
            _A("RACE_UNDEAD_GHOUL", "ghoul famelico", "Ghoul Famelico", "Un ghoul striscia a quattro zampe verso di te.", "Artigli neri e lingua biforcuta.", "Il ghoul morde famelico.", "Masticare carne."),
            ...
            _A("RACE_UNDEAD_SPECTRE", "spettro errante", "Spettro Errante", "Uno spettro fluttuata attraverso le pareti.", "Voce sussurrante promette morte.", "Lo spettro attraversa la tua difesa.", "Sussurri gelidi."),
            _A("RACE_GHOST", "fantasma prigioniero", "Fantasma Prigioniero", "Un fantasma incatenato alla caverna urla silenziosamente.", "Catene spettrali gli legano polsi e caviglie.", "Il fantasma stritola con catene.", "Lamentele ovattate."),
    ...
    cats.append(
        [
            ...
            _A("RACE_UNDEAD_SPECTRE", "spettro guerriero", "Spettro Guerriero", "Uno spettro in armatura antica fluttua minaccioso.", "Spada spettrale attraversa la roccia.", "Lo spettro falcia.", "Lame che fischiano nel vuoto."),
    ...
    cats.append(
        [
            ...
            _A("RACE_ARACHNID", "ragno gigante", "Ragno Gigante", "Un ragno gigante copre metà del soffitto.", "Seta fresca ancora umida di prede.", "Il ragno avvolge in seta.", "Ragnatele che vibrano."),
            ...
            _A("RACE_INSECT", "sciamatore caverna", "Sciamatore di Caverna", "Un insetto corazzato fruga tra le pietre con antenne tese.", "Mandibole lucide hanno morsicato ossa recenti.", "Lo sciamatore batte le ali.", "Un ronzio acuto riempie la stanza."),
        ]
    )
    ...
    cats.append(
        [
            ...
            _A("RACE_INSECT", "mantide caverna", "Mantide di Caverna", "Una mantide verde scuro ferma le zampe a forbice.", "Sguardo alieno non tradisce emozione.", "La mantide falcia.", "Fruscio secco."),
            ...
            _A("RACE_INSECT", "scarafaggio caverna", "Scarafaggio di Caverna", "Uno scarafaggio immenso striscia dal buio.", "Antenne captano ogni odore.", "Lo scarafaggio attacca.", "Fruscio viscido."),
        ]
    )
    ...
    cats.append(
        [
            ...
            _A("RACE_REPTILE", "geco caverna", "Geco di Caverna", "Un geco enorme mimetizzato attende sul soffitto.", "Pelle cambia colore con la roccia.", "Il geco cade addosso.", "Fruscio improvviso."),
            ...
            _A("RACE_SNAKE", "aspide nero", "Aspide Nero", "Un serpente nero lucido si muove silenzioso.", "Veleno letale in gocce alle zanne.", "L'aspide morde rapidamente.", "Sibilo quasi impercettibile."),
            _A("RACE_REPTILE", "basilisco giovane", "Basilisco Giovane", "Un basilisco immature evita il tuo sguardo.", "Pelle grigia simula pietra.", "Il basilisco morde.", "Sibilo roco."),
            _A("RACE_SNAKE", "serpente nebbia", "Serpente della Nebbia", "Un serpente traslucido emerge dal vapore.", "Corpo sembra fatto di bruma solidificata.", "Il serpente morde gelido.", "Vapore che si condensa."),
        ]
    )
    ...
    cats.append(
        [
            ...
            _A("RACE_PREDATOR", "ibrido worg", "Worg Ibrido", "Un worg corrotto dalla dimensione ringhia distorto.", "Zanne irregolari e saliva nera.", "Il worg si scaglia.", "Ringhio metallico."),
            ...
            _A("RACE_PREDATOR", "ibrido ratto gigante", "Ratto Gigante Corrotto", "Un ratto grosso come un cane mostra zanne innaturali.", "Pelliccia rada e occhi rossi.", "Il ratto attacca in branco.", "Squittii minacciosi."),
    ...
    cats.append(
        [
            ...
            _A("RACE_BIRD", "arpia giovane", "Arpia Giovane", "Una arpia immatura plana goffamente.", "Artigli non ancora maturi ma affilati.", "L'arpia graffia.", "Grido acuto."),
            ...
            _A("RACE_BIRD", "condor profondita", "Condor delle Profondita'", "Un condor macilento scende dal soffitto.", "Ali spaziali oscurano la luce.", "Il condor artiglia.", "Vento d'ali."),
            _A("RACE_BIRD", "rondine caverna", "Rondine di Caverna", "Rondini giganti volteggiano minacciose.", "Becco corto ma veloce.", "Le rondini attaccano in sciame.", "Cinguettii cavernosi."),
    ...
    cats.append(
        [
            ...
            _A("RACE_DRAAGDIM", "duergar chierico", "Duergar Chierico", "Un duergar chierico invoca oscurita'.", "Simboli profani brillano sull'armatura.", "Il chierico maledice.", "Preghiere profane."),
            _A("RACE_GOLEM", "golem pietra minore", "Golem di Pietra Minore", "Un golem di pietra animato avanza goffamente.", "Runa incise pulsano debolmente.", "Il golem colpisce.", "Pietre che stridono."),
            ...
            _A("RACE_GNOME", "gnomo fessura", "Gnomo delle Fessure", "Un piccolo umanoide dalle mani artigliate ti osserva dall'ombra.", "Occhi troppo grandi brillano di malizia famelica.", "Lo gnomo sibila un'imprecazione.", "Senti un riso stridulo."),
    ...
    cats.append(
        [
            ...
            _A("RACE_ELVEN", "elfo custode", "Elfo Custode", "Un custode elfico protegge un passaggio antico.", "Runa elfiche brillano sull'arco.", "Il custode scocca.", "Canti elfici lontani."),
    ...
    cats.append(
        [
            ...
            _A("RACE_SLIME", "muffa vivente", "Muffa Vivente", "Una muffa senziente si espande sulle pareti.", "Spore verdi riempiono l'aria.", "La muffa attacca.", "Tossire e starnuti."),
            _A("RACE_DEMON", "manes caverna", "Manes di Caverna", "Un manes distorto striscia come fumo solido.", "Volto muta continuamente.", "Il manes attacca.", "Lamenti distorti."),
    ...
    cats.append(
        [
            _A("RACE_MFLAYER", "mind flayer giovane", "Mind Flayer Giovane", "Un mind flayer immature tenta di entrare nella tua mente.", "Tentacoli facciali si contorcono.", "Il mind flayer attacca.", "Sussurri psichici."),
            _A("RACE_SPECIAL", "mimica giovane", "Mimica Giovane", "Una cassa che si apre a fauci e' in realta' una mimica.", "Lingua viscida lecca l'aria.", "La mimica morde.", "Tonfo di legno."),
            _A("RACE_SPECIAL", "mimica scrigno", "Mimica Scrigno", "Uno scrigno dorato attende troppo comodo per essere vero.", "Serratura e' in realta' un occhio.", "Lo scrigno morde.", "Scricchiolio metallico."),
            ...
            _A("RACE_ASTRAL", "creatura astrale minore", "Creatura Astrale Minore", "Una creatura planare fluttua instabile.", "Forma cambia continuamente.", "La creatura attacca.", "Echi lontani."),
            _A("RACE_PLANAR", "ombra planare", "Ombra Planare", "Un'ombra planare si stacca dal muro.", "Freddo non e' di questo mondo.", "L'ombra avvolge.", "Silenzio innaturale."),
            ...
            _A("RACE_MFLAYER", "illithid servitore", "Illithid Servitore", "Un servitore illithid obbedisce a un padrone lontano.", "Tentacoli tengono lama psionica.", "Il servitore attacca.", "Pulsazioni mentali."),
        ]
    )
    ...
    cats.append(
        [
            ...
            _A("RACE_TREE", "treant giovane", "Treant Giovane", "Un treant giovane si muove goffamente.", "Rami corteggiano il soffitto.", "Il treant schianta.", "Legno che scricchiola."),
            ...
            _A("RACE_PREDATOR", "predatore bruma", "Predatore della Bruma", "Un predatore nato nel velo caccia silenzioso.", "Pelliccia grigia e occhi argentati.", "Il predatore piomba.", "Ringhio ovattato."),
